...
за исключением случаев, когда им разделяются токены, которые иначе были бы объединены в один токен. Однако, новая строка или конец файла могут вызывать вставку точки с запятой.
...
Формальный синтаксис использует точки с запятой ```;``` в качестве признака конца в некоторых языковых конструкциях.
