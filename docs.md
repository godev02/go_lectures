...
Повтор     = "{" Выражение "}" .
```
Формальное описание синтаксиса задаётся при помощи набора правил, которые могут ссылаться друг на друга. Каждое правило имеет имя описывается выражением,
которое состоит из вариантов возможных значений и операторов, имеющих следующий приоритет в порядке возрастания:
```
