...
1_.5         // неверно: в десятичном литерале _ должно быть между цифрами
1._5         // неверно: в десятичном литерале _ должно быть между цифрами
1.5_e1       // неверно: в десятичном литерале _ должно быть между цифрами
1.5e_1       // неверно: в десятичном литерале _ должно быть между цифрами
1.5e1_       // неверно: в десятичном литерале _ должно быть между цифрами
```
