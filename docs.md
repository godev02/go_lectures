...
1. *Однострочные комментарии* начинаются с символов ```//``` и заканчиваются в конце строки.
2. *Общие комментарии* начинаются с символов ```/*``` и заканчиваются первой найденной далее последовательностью ```*/```.
