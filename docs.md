...
Десятичный литерал с плавающей точкой состоит из целой части (разряды записываются десятичными цифрами), десятичной точки, дробной части (разряды записываются десятичными цифрами) и 
экспоненциальной части (e или E, за которыми следуют необязательный знак ``` + ``` или ``` - ``` и разряды десятичными цифрами).
