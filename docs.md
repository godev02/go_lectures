...
При разбиении исходного кода программы на токены, следующий токен &ndash; это самая длинная последовательность символов, которая образует допустимый токен.
