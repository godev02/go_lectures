...
за исключением случаев, когда при помощи него разделяются токены, которые иначе были бы объединены в один токен.
Однако, перевод строки или конец файла могут вызывать вставку точки с запятой.
